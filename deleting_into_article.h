#ifndef deleting_into_article_H
#define deleting_into_article_H
...
namespace Ui {
class deleting_into_article;
}

class deleting_into_article : public QWidget
{
    Q_OBJECT

public:
    explicit deleting_into_article(QWidget *parent = nullptr);
...
private:
    Ui::deleting_into_article *ui;
    bool m_dragging = false;
    QPoint m_dragPosition;
};

#endif // deleting_into_article_H
