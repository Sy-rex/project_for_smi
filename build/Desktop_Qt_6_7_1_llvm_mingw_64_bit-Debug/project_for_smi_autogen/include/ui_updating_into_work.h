/********************************************************************************
** Form generated from reading UI file 'updating_into_work.ui'
**
...
#ifndef UI_UPDATING_INTO_WORK_H
#define UI_UPDATING_INTO_WORK_H
...
class Ui_updating_into_work
{
public:
    QTableView *tableView;

    void setupUi(QWidget *updating_into_work)
    {
        if (updating_into_work->objectName().isEmpty())
            updating_into_work->setObjectName("updating_into_work");
        updating_into_work->resize(641, 508);
        tableView = new QTableView(updating_into_work);
...
"}"));
        ...
        retranslateUi(updating_into_work);

        QMetaObject::connectSlotsByName(updating_into_work);
    } // setupUi

    void retranslateUi(QWidget *updating_into_work)
    {
        updating_into_work->setWindowTitle(QCoreApplication::translate("updating_into_work", "Form", nullptr));
    } // retranslateUi

};

namespace Ui {
    class updating_into_work: public Ui_updating_into_work {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_UPDATING_INTO_WORK_H
