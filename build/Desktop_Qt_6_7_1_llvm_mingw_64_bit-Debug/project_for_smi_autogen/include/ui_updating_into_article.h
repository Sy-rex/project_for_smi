/********************************************************************************
** Form generated from reading UI file 'updating_into_article.ui'
**
...
#ifndef UI_UPDATING_INTO_ARTICLE_H
#define UI_UPDATING_INTO_ARTICLE_H
...
class Ui_updating_into_article
{
public:
    QTableView *tableView;

    void setupUi(QWidget *updating_into_article)
    {
        if (updating_into_article->objectName().isEmpty())
            updating_into_article->setObjectName("updating_into_article");
        updating_into_article->resize(653, 559);
        tableView = new QTableView(updating_into_article);
...
"}"));
        ...
        retranslateUi(updating_into_article);

        QMetaObject::connectSlotsByName(updating_into_article);
    } // setupUi

    void retranslateUi(QWidget *updating_into_article)
    {
        updating_into_article->setWindowTitle(QCoreApplication::translate("updating_into_article", "Form", nullptr));
    } // retranslateUi

};

namespace Ui {
    class updating_into_article: public Ui_updating_into_article {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_UPDATING_INTO_ARTICLE_H
