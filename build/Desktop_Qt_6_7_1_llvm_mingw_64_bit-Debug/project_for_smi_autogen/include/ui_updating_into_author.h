/********************************************************************************
** Form generated from reading UI file 'updating_into_author.ui'
**
...
#ifndef UI_UPDATING_INTO_AUTHOR_H
#define UI_UPDATING_INTO_AUTHOR_H
...
class Ui_updating_into_author
{
public:
    QTableView *tableView;

    void setupUi(QWidget *updating_into_author)
    {
        if (updating_into_author->objectName().isEmpty())
            updating_into_author->setObjectName("updating_into_author");
        updating_into_author->resize(675, 524);
        tableView = new QTableView(updating_into_author);
...
"}"));
        ...
        retranslateUi(updating_into_author);

        QMetaObject::connectSlotsByName(updating_into_author);
    } // setupUi

    void retranslateUi(QWidget *updating_into_author)
    {
        updating_into_author->setWindowTitle(QCoreApplication::translate("updating_into_author", "Form", nullptr));
    } // retranslateUi

};

namespace Ui {
    class updating_into_author: public Ui_updating_into_author {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_UPDATING_INTO_AUTHOR_H
