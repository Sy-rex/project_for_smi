/********************************************************************************
** Form generated from reading UI file 'deleting_into_edition.ui'
**
...
#ifndef UI_DELETING_INTO_EDITION_H
#define UI_DELETING_INTO_EDITION_H
...
class Ui_deleting_into_edition
{
public:
    QTableView *tableView;

    void setupUi(QWidget *deleting_into_edition)
    {
        if (deleting_into_edition->objectName().isEmpty())
            deleting_into_edition->setObjectName("deleting_into_edition");
        deleting_into_edition->resize(680, 497);
        tableView = new QTableView(deleting_into_edition);
...
"}"));
        ...
        retranslateUi(deleting_into_edition);

        QMetaObject::connectSlotsByName(deleting_into_edition);
    } // setupUi

    void retranslateUi(QWidget *deleting_into_edition)
    {
        deleting_into_edition->setWindowTitle(QCoreApplication::translate("deleting_into_edition", "Form", nullptr));
    } // retranslateUi

};

namespace Ui {
    class deleting_into_edition: public Ui_deleting_into_edition {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_DELETING_INTO_EDITION_H
