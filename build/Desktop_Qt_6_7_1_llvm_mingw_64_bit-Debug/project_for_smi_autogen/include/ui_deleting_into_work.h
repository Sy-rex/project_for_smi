/********************************************************************************
** Form generated from reading UI file 'deleting_into_work.ui'
**
...
#ifndef UI_DELETING_INTO_WORK_H
#define UI_DELETING_INTO_WORK_H
...
class Ui_deleting_into_work
{
public:
    QTableView *tableView;

    void setupUi(QWidget *deleting_into_work)
    {
        if (deleting_into_work->objectName().isEmpty())
            deleting_into_work->setObjectName("deleting_into_work");
        deleting_into_work->resize(651, 481);
        tableView = new QTableView(deleting_into_work);
...
"}"));
        ...
        retranslateUi(deleting_into_work);

        QMetaObject::connectSlotsByName(deleting_into_work);
    } // setupUi

    void retranslateUi(QWidget *deleting_into_work)
    {
        deleting_into_work->setWindowTitle(QCoreApplication::translate("deleting_into_work", "Form", nullptr));
    } // retranslateUi

};

namespace Ui {
    class deleting_into_work: public Ui_deleting_into_work {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_DELETING_INTO_WORK_H
