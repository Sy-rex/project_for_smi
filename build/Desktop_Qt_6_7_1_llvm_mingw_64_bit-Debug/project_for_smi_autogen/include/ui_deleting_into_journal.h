/********************************************************************************
** Form generated from reading UI file 'deleting_into_journal.ui'
**
...
#ifndef UI_DELETING_INTO_JOURNAL_H
#define UI_DELETING_INTO_JOURNAL_H
...
class Ui_deleting_into_journal
{
public:
    QTableView *tableView;

    void setupUi(QWidget *deleting_into_journal)
    {
        if (deleting_into_journal->objectName().isEmpty())
            deleting_into_journal->setObjectName("deleting_into_journal");
        deleting_into_journal->resize(641, 601);
        tableView = new QTableView(deleting_into_journal);
...
"}"));
        ...
        retranslateUi(deleting_into_journal);

        QMetaObject::connectSlotsByName(deleting_into_journal);
    } // setupUi

    void retranslateUi(QWidget *deleting_into_journal)
    {
        deleting_into_journal->setWindowTitle(QCoreApplication::translate("deleting_into_journal", "Form", nullptr));
    } // retranslateUi

};

namespace Ui {
    class deleting_into_journal: public Ui_deleting_into_journal {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_DELETING_INTO_JOURNAL_H
