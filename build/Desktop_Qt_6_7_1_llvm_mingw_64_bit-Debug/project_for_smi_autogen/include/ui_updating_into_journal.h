/********************************************************************************
** Form generated from reading UI file 'updating_into_journal.ui'
**
...
#ifndef UI_UPDATING_INTO_JOURNAL_H
#define UI_UPDATING_INTO_JOURNAL_H
...
class Ui_updating_into_journal
{
public:
    QTableView *tableView;

    void setupUi(QWidget *updating_into_journal)
    {
        if (updating_into_journal->objectName().isEmpty())
            updating_into_journal->setObjectName("updating_into_journal");
        updating_into_journal->resize(690, 504);
        tableView = new QTableView(updating_into_journal);
...
"}"));
        ...
        retranslateUi(updating_into_journal);

        QMetaObject::connectSlotsByName(updating_into_journal);
    } // setupUi

    void retranslateUi(QWidget *updating_into_journal)
    {
        updating_into_journal->setWindowTitle(QCoreApplication::translate("updating_into_journal", "Form", nullptr));
    } // retranslateUi

};

namespace Ui {
    class updating_into_journal: public Ui_updating_into_journal {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_UPDATING_INTO_JOURNAL_H
