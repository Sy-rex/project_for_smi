#ifndef deleting_into_work_H
#define deleting_into_work_H
...
namespace Ui {
class deleting_into_work;
}

class deleting_into_work : public QWidget
{
    Q_OBJECT

public:
    explicit deleting_into_work(QWidget *parent = nullptr);
    ~deleting_into_work();
