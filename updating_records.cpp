...
updating_records::updating_records(QWidget *parent)
    : QWidget(parent)
    , ui(new Ui::updating_records)
{
    ui->setupUi(this);
    ...
    QLabel *label1 = new QLabel("UPDATING RECORDS", this);
    ...
    connect(menuButton, &QPushButton::clicked, this, &updating_records::openMainWindow);
    ...
    connect(imageButton2, &QPushButton::clicked, this, &updating_records::onFirstButtonClicked);

    connect(imageButton3, &QPushButton::clicked, this, &updating_records::onSecondButtonClicked);

    connect(imageButton4, &QPushButton::clicked, this, &updating_records::onThirdButtonClicked);

    connect(imageButton8, &QPushButton::clicked, this, &updating_records::onFourthButtonClicked);

    connect(imageButton9, &QPushButton::clicked, this, &updating_records::onFifthButtonClicked);
}

updating_records::~updating_records()
{
    delete ui;
}

void updating_records::paintEvent(QPaintEvent *event)
{
...
void updating_records::openMainWindow()
{
...
void updating_records::onFirstButtonClicked()
{
    // Создание и отображение окна Stream_window
    updating_into_journal *updating_journal = new updating_into_journal();
    updating_journal->show();
    this->close();
}

void updating_records::onSecondButtonClicked()
{
    // Создание и отображение окна Stream_window
    updating_into_author *updating_author = new updating_into_author();
    updating_author->show();
    this->close();
}

void updating_records::onThirdButtonClicked()
{
    // Создание и отображение окна Stream_window
    updating_into_edition *updating_edition = new updating_into_edition();
    updating_edition->show();
    this->close();
}

void updating_records::onFourthButtonClicked()
{
    // Создание и отображение окна Stream_window
    updating_into_article *updating_article = new updating_into_article();
    updating_article->show();
    this->close();
}

void updating_records::onFifthButtonClicked()
{
    // Создание и отображение окна Stream_window
    updating_into_work *updating_work = new updating_into_work();
    updating_work->show();
    this->close();
}
