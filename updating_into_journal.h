#ifndef updating_into_journal_H
#define updating_into_journal_H
...
namespace Ui {
class updating_into_journal;
}

class updating_into_journal : public QWidget
{
    Q_OBJECT

public:
    explicit updating_into_journal(QWidget *parent = nullptr);
...
private:
    Ui::updating_into_journal *ui;
    bool m_dragging = false;
    QPoint m_dragPosition;
    updating_journal *journalWindow;
};

#endif // updating_into_journal_H
