...
updating_into_journal::updating_into_journal(QWidget *parent)
    : QWidget(parent)
    , ui(new Ui::updating_into_journal)
{
    ui->setupUi(this);
    ...
    connect(menuButton, &QPushButton::clicked, this, &updating_into_journal::openMainWindow);
...
updating_into_journal::~updating_into_journal()
{
    delete ui;
}

void updating_into_journal::paintEvent(QPaintEvent *event)
{
...
void updating_into_journal::openMainWindow()
{
