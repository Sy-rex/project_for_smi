...
#include "ui_deleting_records.h"
#include "deleting_into_journal.h"
#include "deleting_into_author.h"
#include "deleting_into_article.h"
#include "deleting_into_edition.h"
...
deleting_records::deleting_records(QWidget *parent)
    : QWidget(parent)
    , ui(new Ui::deleting_records)
{
    ui->setupUi(this);
    ...
    QLabel *label1 = new QLabel("DELETING RECORDS", this);
    ...
    connect(menuButton, &QPushButton::clicked, this, &deleting_records::openMainWindow);
    ...
    // Загружаем изображение из файла ресурсов
    QPixmap pixmap5(":/description_journal_edit.png");
    ...
    // Загружаем изображение из файла ресурсов
    QPixmap pixmap6(":/description_author_edit.png");
    ...
    // Загружаем изображение из файла ресурсов
    QPixmap pixmap7(":/description_edition_edit.png");
    ...
    // Загружаем изображение из файла ресурсов
    QPixmap pixmap10(":/description_article_edit.png");
    ...
    connect(imageButton2, &QPushButton::clicked, this, &deleting_records::onFirstButtonClicked);

    connect(imageButton3, &QPushButton::clicked, this, &deleting_records::onSecondButtonClicked);

    connect(imageButton4, &QPushButton::clicked, this, &deleting_records::onThirdButtonClicked);

    connect(imageButton8, &QPushButton::clicked, this, &deleting_records::onFourthButtonClicked);

    connect(imageButton9, &QPushButton::clicked, this, &deleting_records::onFifthButtonClicked);
}
...
void deleting_records::paintEvent(QPaintEvent *event)
{
...
void deleting_records::openMainWindow()
{
...
void deleting_records::onFirstButtonClicked()
{
    // Создание и отображение окна Stream_window
    deleting_into_journal *deleting_journal = new deleting_into_journal();
    deleting_journal->show();
    this->close();
}

void deleting_records::onSecondButtonClicked()
{
    // Создание и отображение окна Stream_window
    deleting_into_author *deleting_author = new deleting_into_author();
    deleting_author->show();
    this->close();
}

void deleting_records::onThirdButtonClicked()
{
    // Создание и отображение окна Stream_window
    deleting_into_edition *deleting_edition = new deleting_into_edition();
    deleting_edition->show();
    this->close();
}

void deleting_records::onFourthButtonClicked()
{
    // Создание и отображение окна Stream_window
    deleting_into_article *deleting_article = new deleting_into_article();
    deleting_article->show();
    this->close();
}

void deleting_records::onFifthButtonClicked()
{
    // Создание и отображение окна Stream_window
    deleting_into_work *deleting_work = new deleting_into_work();
    deleting_work->show();
    this->close();
}
